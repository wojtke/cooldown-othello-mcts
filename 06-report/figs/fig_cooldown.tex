...
\end{tikzpicture}
\caption{czarny stawia z~prawej i~bije linię dwóch białych}
\end{subfigure}\hfill
...
\end{tikzpicture}
\caption{nowy i~odwrócone pionki \emph{stygną} (pomarańczowe -- chronione 1~turę)}
\end{subfigure}\hfill
...
\othx{1.5}{2.5}
\end{tikzpicture}
\caption{biały nie odbije od~razu -- ostudzony pionek jest przezroczysty, ruch \emph{nielegalny}}
\end{subfigure}
