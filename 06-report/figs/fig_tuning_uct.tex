\pgfplotsset{tuneaxis/.style={width=7.4cm, height=5.2cm, ymin=0.7, ymax=1.0,
  ...
  legend style={font=\scriptsize, fill=white, fill opacity=0.9, draw=gray!60,
    at={(0.03,0.04)}, anchor=south west, legend cell align=left}}}
...
\addlegendentry{próby Optuny}
\addplot[red,densely dashed,thick] coordinates {(2.23,0.7) (2.23,1.0)};
\addlegendentry{najlepsze $c$}
\addplot[black,densely dotted,very thick] coordinates {(1.414,0.7) (1.414,1.0)};
\addlegendentry{$\sqrt2$ (lit.)}
...
\addplot[red,densely dashed,thick] coordinates {(0.52,0.7) (0.52,1.0)};
\addplot[black,densely dotted,very thick] coordinates {(1.414,0.7) (1.414,1.0)};
...
Optuny). Czerwona linia przerywana -- najlepsze $c$, czarna kropkowana -- $\sqrt2$ (literatura).
